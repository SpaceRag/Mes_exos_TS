...
const favCountry: string[] = ["France", "Portugal", "Argentine", "Espagne", "Russie"]; 
...
// function (arr: string[]): string {
//   return arr.join("");
// }

// const developmt: string = joinString(letters);
// console.log(developmt);
